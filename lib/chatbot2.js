...
ChatBot.prototype.parseDirections = function (context, entities, cb) {
...
ChatBot.prototype.parseAvailability = function (context, entities, cb) {
	entities = this.normalize(entities);
	entities = _.extend(entities, this.equiv || {});
...
ChatBot.prototype.parseRoomInfo = function (context, entities, cb) {
	entities = this.normalize(entities);
...
ChatBot.prototype.action = function (context, entities, cb) {
...
ChatBot.prototype.respond = function (message, equiv, cb) {
